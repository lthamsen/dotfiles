...
rofi_launcher = spawn "rofi -no-lazy-grab -show drun -modi run,drun,window -theme $HOME/.config/rofi/themes/launchpad -drun-icon-theme \"candy-icons\" "
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_g), sendMessage $ setGaps [(L,2), (R,2), (U,25), (D,2)]) -- reset the GapSpec
...
myMouseBindings (XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- mod-button1, Set the window to floa0x181a20ting mode and move by dragging
...
--
myLayout = avoidStruts(tiled ||| Mirror tiled ||| Full ||| mSpiral)
  where
...
myWorkspaces = [" dev ", " www ", " sys ", " doc ", " vm ", " chat ", " mus ", " vid ", " mat "]
...
myStartupHook = do
  ...
  --spawnOnce "feh --bg-scale ~/wallpapers/bergebruh.jpg"
  spawnOnce "picom --experimental-backends --xrender-sync -f"
  spawnOnce "greenclip daemon"
  spawnOnce "dunst"
  spawnOnce "exec ~/.xmonad/nitro.fish"
  spawnOnce "exec ~/.xmonad/op.sh"
  spawnOnce "sleep 2 dropbox"
  ...
  spawnOnce "sleep 3 && nm-applet"
  spawnOnce "sleep 3 && volctl"
  --spawnOnce "xmobar"
...
--gaps [(L,3), (R,3), (U,5), (D,3)] $
      -- hooks, layouts
        manageHook = myManageHook, 
        layoutHook = spacingRaw True (Border 3 3 3 3) True (Border 3 3 3 3) True $ smartBorders myLayout,
...
-- | Finally, a copy of the default bindings in simple textual tabular foppprmat.
help :: String
